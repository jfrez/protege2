...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($existing_data) {
        ...
        if ($stmt->execute()) {
            ...
            header('Location: seccion7.php' . $evaluacionIdQuery);
        } else {
...
<div class="container mt-5">
    ...
    <form method="POST" action="seccion6.php<?= htmlspecialchars($evaluacionIdQuery); ?>">
        ...
        <a type="button" class="btn btn-secondary mt-3" href="seccion5.php<?= htmlspecialchars($evaluacionIdQuery); ?>">Anterior</a>
