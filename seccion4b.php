...
La vivencia de abuso en la infancia representa un factor de riesgo para la adopción de conductas abusivas en la edad adulta, aunque la conexión entre estos dos factores no debe ser interpretada como una relación directa e inevitable (Paúl et al., 2002). La recurrencia del maltrato hacia niños, niñas y adolescentes se asocia a la historia de maltrato infantil del perpetrador o perpetradora (Horikawa et al., 2016).',
        'opciones' => [
            'a' => 'No es posible determinar / No aplica — Falta información o la figura perpetradora es cuidadora.',
            'b' => 'Riesgo nulo o bajo — Sin reportes de maltrato, o bien fueron hechos leves y no sistemáticos.',
            'c' => 'Riesgo medio — Hubo episodios de maltrato o negligencia moderados en la infancia del perpetrador/a.',
            'd' => 'Riesgo alto — Se constataron episodios graves y/o sistemáticos de maltrato en la infancia del perpetrador/a.'
        ]
    ],
    'presencia_pares_confianza_nna' => [
...
En contraste, las relaciones escasas o de baja calidad con el grupo constituyen un factor de riesgo en estas poblaciones, siendo estos jóvenes potencialmente rechazados o impopulares entre sus pares (Favre et al., 2022).',
        'opciones' => [
            'a' => 'No es posible determinar — No se cuenta con información suficiente para evaluar la calidad de las relaciones con pares.',
            'b' => 'Protección nula o baja — El NNA no cuenta con relaciones cercanas ni de calidad con sus pares.',
            'c' => 'Protección media — El NNA cuenta con al menos un par de confianza al que recurrir.',
            'd' => 'Protección alta — El NNA mantiene relaciones de calidad con varios pares, pudiendo recurrir a ellos.'
        ]
    ],
    'involucramiento_previo_servicio_proteccion' => [
...
En Chile, los niños, niñas y adolescentes atendidos por el sistema de protección especializada presentan –en su mayoría- una historia de institucionalización e intervención de larga data por parte del Estado (SENAME, 2019). En este caso, la multiplicidad de ingresos al Servicio de Protección Especializada, constituyen un proxy a los nuevos reportes de abuso o maltrato, que aumentan el riesgo de futuras victimizaciones.',
        'opciones' => [
            'a' => 'No es posible determinar — No hay información suficiente sobre el historial de ingresos al sistema de protección.',
            'b' => 'Riesgo nulo o bajo — El NNA no presenta historial de ingresos al servicio de protección especializada.',
            'c' => 'Riesgo medio — El NNA presenta 1 o 2 ingresos previos al servicio de protección especializada.',
            'd' => 'Riesgo alto — El NNA presenta 3 o más ingresos previos al servicio de protección especializada.'
        ]
    ]
];
?>
